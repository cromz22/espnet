# This script is adopted from https://github.com/SpeechColab/GigaSpeech/blob/main/toolkits/kaldi/extract_meta.py which is licensed under Apache-2.0 License.
