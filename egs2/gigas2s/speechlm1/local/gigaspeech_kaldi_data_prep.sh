#!/usr/bin/env bash
# This script is adopted from https://github.com/SpeechColab/GigaSpeech/blob/main/toolkits/kaldi/gigaspeech_data_prep.sh which is licensed under Apache 2.0.
...
if [ $stage -le 1 ]; then
  ...
  python3 local/gigaspeech_extract_meta.py \
    --pipe-format $gigaspeech_dir/GigaSpeechXS.json $corpus_dir || exit 1;  # TODO: Change to GigaSpeech.json
